...
This web page is programmed to take valid user input and display the factorial or summation, whatever user selects. To run the program, first, download the zip file and unzip it. Then run the node server on your computer. You can run in on your terminal/cmd. To run the server first go to the directory where the assignment folder is and then in the terminal, and then type "node myserver.js" without the quotes.
